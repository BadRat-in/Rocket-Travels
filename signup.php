...
<body>
    ...
    <center>
        ...
        <div class="form">
            ...
            if ($error === 1) {
                echo "<div><h4 style='color: #ee3333; font-size: 18px; width: auto; height: auto; background-color: burlywood;'><i class='fas fa-error'></i>Email or Mobile Number is already registered with another account</h4></div>";
            }
        ?>
                    <th colspan="2">Sign Up</th>
                    <tr>
                        <td><label for="name">Name</label></td>
                        <td><input type="text" name="name" class="input_field" placeholder="Name" minlength="6"
                                required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="number" class="input_field" placeholder="Number" minlength="10"
            ...
            <br>
            <a href="./signin.php?error=0&user=" style="color: red;"><h3 style="margin-top: 5px; color: white;">Already have an account.</h3></a>
        </div>
    </center>
